...
$custom_prefooter = etheme_get_custom_field('custom_prefooter');
$disable_copyrights = etheme_get_custom_field('remove_copyrights');
?>
...
<div class="et-footers-wrapper">
	<?php if( ( function_exists('is_checkout') && ! is_checkout() ) || ! function_exists('is_checkout') ):  ?>
		<?php if( $custom_prefooter != 'without' && is_active_sidebar('prefooter') ): ?>
